            ...
            <div class="col-md-8">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-primary text-white py-3">
                        <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Cập nhật danh mục: <?= htmlspecialchars($category['name']) ?></h5>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form action="?act=admin-category-edit&id=<?= $category['id'] ?>" method="POST">
                            <div class="mb-3">
                ...
                <p class="text-center mt-3 text-muted small text-uppercase">Đang chỉnh sửa bản ghi #<?= $category['id'] ?></p>
            </div>
        </div>
    </div>
